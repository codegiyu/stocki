...
$email = $_SESSION['email'];
    ...
    $money = $conn->prepare("SELECT * FROM money ORDER BY moneyID DESC LIMIT 1");
    $money->execute();
    $balance = $money->fetch();
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>Balance</title>
    <link rel="stylesheet" type="text/css" href="css/balancestyle.css">
</head>
<body>
    <header>
    ...
    <section>
        <div class="container">
            <div id="balance">
                ...
                <p>₦<?php echo number_format($balance['moneyamount']) ?></p>
            </div>
        </div>
    </section>
</body>
